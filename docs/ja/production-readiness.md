...
Current public status: 0.x preview is published on NuGet (2026-06-01)。Maintainer dogfooding は稼働中: [slicefx-inbox](https://github.com/sano-suguru/slicefx-inbox)（Fermyon Cloud / Spin WASI）。
