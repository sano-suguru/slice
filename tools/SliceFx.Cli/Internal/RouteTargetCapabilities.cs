...
internal sealed record RouteCapability(string Status, string? Reason, IReadOnlyList<WasiCompatibilityIssue>? Issues = null)
{
    public IReadOnlyList<WasiCompatibilityIssue> Issues { get; init; } = Issues ?? [];
}
